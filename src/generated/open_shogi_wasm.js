/* @ts-self-types="./open_shogi_wasm.d.ts" */

export class WasmBrowserEngine {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WasmBrowserEngineFinalization.unregister(this);
        return ptr;
    }
    free() {
     ...
     * @returns {string}
     */
    loadModel(bytes, expected_artifact_sha256) {
        let deferred4_0;
        let deferred4_1;
        try {
    ...
    constructor() {
        const ret = wasm.wasmbrowserengine_new();
        this.__wbg_ptr = ret;
        WasmBrowserEngineFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    playMove(movement) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmbrowserengine_playMove(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    reset(sfen) {
        ...
        let deferred3_1;
        try {
            var ptr0 = isLikeNone(sfen) ? 0 : passStringToWasm0(sfen, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmbrowserengine_reset(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    restore(initial_sfen, moves_json) {
        ...
        let deferred4_1;
        try {
            const ptr0 = passStringToWasm0(initial_sfen, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(moves_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ret = wasm.wasmbrowserengine_restore(this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var ptr3 = ret[0];
            var len3 = ret[1];
            if (ret[3]) {
                ptr3 = 0; len3 = 0;
     ...
     * @returns {string}
     */
    search(profile, evaluator, multi_pv) {
        let deferred4_0;
        let deferred4_1;
        try {
            const ptr0 = passStringToWasm0(profile, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            ...
            const ptr1 = passStringToWasm0(evaluator, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ret = wasm.wasmbrowserengine_search(this.__wbg_ptr, ptr0, len0, ptr1, len1, multi_pv);
            var ptr3 = ret[0];
            var len3 = ret[1];
            if (ret[3]) {
                ptr3 = 0; len3 = 0;
    ...
    snapshot() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.wasmbrowserengine_snapshot(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
...
if (Symbol.dispose) WasmBrowserEngine.prototype[Symbol.dispose] = WasmBrowserEngine.prototype.free;

export class WasmOsaval02Model {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WasmOsaval02ModelFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmosaval02model_free(ptr, 0);
    }
    /**
     * @param {string} sfen
     * @param {string | null} [history_json]
     * @returns {string}
     */
    deterministicTest(sfen, history_json) {
        let deferred4_0;
        let deferred4_1;
        try {
            const ptr0 = passStringToWasm0(sfen, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            var ptr1 = isLikeNone(history_json) ? 0 : passStringToWasm0(history_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len1 = WASM_VECTOR_LEN;
            const ret = wasm.wasmosaval02model_deterministicTest(this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var ptr3 = ret[0];
            var len3 = ret[1];
            if (ret[3]) {
                ptr3 = 0; len3 = 0;
    ...
    identity() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.wasmosaval02model_identity(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    infer(sfen, history_json) {
        ...
        try {
            ...
            var ptr1 = isLikeNone(history_json) ? 0 : passStringToWasm0(history_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len1 = WASM_VECTOR_LEN;
            const ret = wasm.wasmosaval02model_infer(this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var ptr3 = ret[0];
            var len3 = ret[1];
            if (ret[3]) {
                ptr3 = 0; len3 = 0;
    ...
    constructor(bytes) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmosaval02model_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
        WasmOsaval02ModelFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) WasmOsaval02Model.prototype[Symbol.dispose] = WasmOsaval02Model.prototype.free;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./open_shogi_wasm_bg.js": import0,
    };
}

const WasmBrowserEngineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmbrowserengine_free(ptr, 1));
const WasmOsaval02ModelFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmosaval02model_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('open_shogi_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
